...
def test_min_items_per_user_with_large_value(test_dataframe):
...
def test_min_items_per_user_with_zero_value(test_dataframe):
...
def test_min_items_per_user_dataset(test_dataset, test_dataframe):
